...
def train_model(config_path):
    ...
    pt_file = output_dir / "export" / "weights" / "torch" / "patchcore.pt"
    new_pt_file = output_dir / "export" / "patchcore.pt"

    shutil.move(pt_file, new_pt_file)
    

    config_path = output_dir / "export" / "patchcore.yaml"
...
if __name__ == "__main__":
    ...
    train_model("configs/config_patchcore.yaml")
